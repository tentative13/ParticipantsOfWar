...
namespace ParticipantsOfWar.DAL
{
    public class ArchiveInitializer : DropCreateDatabaseAlways<ArchiveContext>
    {
        protected override void Seed(ArchiveContext context)
        {
            ...
            {
                new ParticipantType{Name = "Участники ВОВ", ParticipantTypeId=Guid.NewGuid(), Priority = 1},
                new ParticipantType{Name = "Труженники тыла", ParticipantTypeId=Guid.NewGuid(), Priority = 2},   
                new ParticipantType{Name = "Дети войны", ParticipantTypeId=Guid.NewGuid(), Priority = 3},
                new ParticipantType{Name = "Участники горячих точек", ParticipantTypeId=Guid.NewGuid(), Priority = 4},
                new ParticipantType{Name= "Репрессированные", ParticipantTypeId=Guid.NewGuid(), Priority = 5}
            };
